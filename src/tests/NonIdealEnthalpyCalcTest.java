...
/*Testing the non ideal enthalpy calculation, a non ideal case is made using a composition of 4 chemicals
...
public class NonIdealEnthalpyCalcTest {
	...
	public static void main(String[] args) throws ValuesOutOfBoundsException,
		...
		double[] compositions = { 0., 0., 0., 0.25, 0.5, 0.25 };
